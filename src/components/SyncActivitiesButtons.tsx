  ...
  return (
    <div className="flex gap-4">
      <button
        ...
        disabled={checkForNewActivitiesMutation.isPending}
      >
        Check for new activities
        {checkForNewActivitiesMutation.isPending && (
          <div role="status">
            <svg
              aria-hidden="true"
      ...
      <button
        ...
        disabled={loadOlderActivitiesMutation.isPending}
      >
        Load older activities
        {loadOlderActivitiesMutation.isPending && (
          <div role="status">
            <svg
              aria-hidden="true"
              className="inline h-4 w-4 animate-spin fill-gray-300 text-gray-200 dark:text-gray-600"
